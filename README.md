...
- Идеология: "как можно меньше лишнего", "если сильно нужно, то можно", "3-5 букв - самое то", "для своей цели должен быть один инструмент, а не набор из устаревших, рекомендуемых и экспериментальных", "лучше умный компилятор, чем усталый программист"
