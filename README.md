...
## Синтаксис
### Общее
- Программа запускается из главного файла, а не из функции main. Запускаемый файл по стандарту должен называться **`main.aq`**. Скомпилированный файл будет называться **`main.water`**.
...
- `Iterable` - абстрактный класс
  ...
  - contains(value) - return true if the value in the iterable.
