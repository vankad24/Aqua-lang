...
## ООП
- Возможно только единичное наследование и множественная реализация интерфейсов. Можно наследовать интерфейс от интерфейса.
...
Наследование только от интерфейсов. Интерфейс не сможет наследоваться от интерфейса? При наследовании от классов компилятор такой: not in this language)
